...
const data = [
  {
    ...
    cardText:
      "DietGPT offers personalized meal suggestions based on user's dietary restrictions, preferences, and ingredient availability. "
  },
  {
    imgsrc: '/bot.png',
  ...
  },
  {
    ...
    cardText:
      'DietGPT could be integrated into other health and fitness apps or devices, such as fitness trackers or grocery delivery services. '
  }
];
        ...
        <div className='container pt-32 max-w-7xl w-full mx-auto h-full'>
          <div className='h-full gap-6 flex flex-col justify-start lg:justify-center items-center lg:items-start'>
            ...
            <Paragraph className='max-w-xl lg:text-left'>
              DietGPT is your friendly pidgin Smart Diet Suggester and Custom
              Meal Plan Creator{' '}
              <Link
                href='/login'
